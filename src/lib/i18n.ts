...
const ar: Dict = {
  ...
  "quran.reciter": "بصوت مشاري راشد العفاسي",
  ...
  "quran.tapForBars": "اضغط وسط الصفحة لإظهار المعلومات",
  ...
  "streak.notifTitle": "سلسلتك على وشك الانقطاع",
  "streak.notifBody": "بقيت ساعة واحدة — اقرأ صفحة الآن لتحافظ على سلسلتك",
  ...
  "install.body": "أيقونة على شاشتك، يفتح كتطبيق حقيقي، ويعمل دون اتصال.",
...
const en: Dict = {
  ...
  "quran.reciter": "Recited by Mishary Rashid Alafasy",
  ...
  "adhkar.salahNotifBody": "Glorify and remember Allah after your prayer — a few easy minutes, a great reward",
  ...
  "quran.full": "Full page",
  "quran.tapForBars": "Tap the middle of the page to show info",
  ...
  "streak.notifTitle": "Your streak is about to break",
  "streak.notifBody": "One hour left — read a page now to keep your streak",
  ...
  "install.body": "An icon on your screen, opens like a real app, works offline.",
