...
const ar: Dict = {
  ...
  "streak.left": "متبقي",
  "streak.hint": "قراءة صفحة تمدّ سلسلتك",
  "streak.notifTitle": "لا تدع سلسلتك تنقطع الليلة",
  "streak.notifBody": "بقيت ساعة — صفحة واحدة تكفي لتبقى سلسلتك",
...
const en: Dict = {
  ...
  "streak.left": "left",
  "streak.hint": "Reading a page extends your streak",
  "streak.notifTitle": "Don't let your streak end tonight",
  "streak.notifBody": "One hour left — a single page keeps it going",
